...
//	private ResourceDao resourceDao;
	...
	public Ini.Section getObject() throws Exception {
		System.out.println("ChainDefinitionSectionMetaSource == > 调用 FactoryBean");
...
//		List<Resource> lists = resourceDao.findAll(new Page("desc", "id", 1000, 0), "");
//		for (Resource resources : lists) {
//			// 构成permission字符串
...
////				String permission = "rest[" + resources.getResKey() + "]";
